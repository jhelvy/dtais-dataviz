...
meta() %>%
  ...
  meta_name("github-repo" = "jhelvy/nrt-dataviz") %>%
  meta_social(
    title = rmarkdown::metadata$title,
    url = "https://jhelvy.github.io/nrt-dataviz/",
    og_type = "website",
...
```{r child="topics/0.qmd"}
```

---

```{r child="topics/1.qmd"}
```
...
- `r fa("check-square", fill = "green")` / `r fa("times", fill = "red")` **Discriminate**
- `r fa("check-square", fill = "green")` / `r fa("times", fill = "red")` **Rank**
- `r fa("check-square", fill = "green")` / `r fa("times", fill = "red")` **Ratio**
...
<center>
<img src="figs/mtCarsScatterGrid4.png" width=800>
</center>
...
```{r child="topics/3.qmd"}
```

---

```{r child="topics/bp0.qmd"}
```

---

```{r child="topics/bp1.qmd"}
```
...
# Download: [Data Viz "Cheat Sheet"](https://github.com/jhelvy/nrt-dataviz/raw/master/content/dataviz-cheatsheet.pdf)
